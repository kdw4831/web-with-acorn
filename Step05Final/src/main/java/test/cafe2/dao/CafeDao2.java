...
import test.cafe2.dto.CafeDto2;
...
public class CafeDao2 {
	...
	public boolean update(CafeDto2 dto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		int rowCount = 0;
		try {
	...
	public CafeDto2 getData(int num) {
		CafeDto2 dto=null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	//새글을 저장하는 메소드 
	public boolean insert(CafeDto2 dto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		int rowCount = 0;
		try {
	...
	public List<CafeDto2> getList(CafeDto2 dto){
		
		List<CafeDto2> list=new ArrayList<CafeDto2>();
