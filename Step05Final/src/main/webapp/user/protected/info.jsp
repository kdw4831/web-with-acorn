			...
			<tr>
				...
				<td>
					<%if(dto.getProfile()==null){ %>
						<svg class="animate__animated animate__jello animate__infinite" width="100" height="100" xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
